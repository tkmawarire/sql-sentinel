...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "SQL Profiler MCP - Debug API",
        Version = "v1",
        Description = "REST API for debugging SQL Profiler MCP server tools without connecting to an AI agent."
    });
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "SQL Profiler MCP - Debug API v1");
